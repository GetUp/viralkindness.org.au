    ...
    <div>
      ...
      <ContentWithSidebar>
        <div>
          ...
          <p>
            But for people who are more isolated, or who we don’t know as well,
          ...
          <p>
            ...
            everyday things such as picking up groceries, getting medication or
          ...
          <ol>
            <li>
              Print off postcards from the link above - follow the instructions
              in the document above. Remember to wash your hands.
            </li>
            <li>
          ...
          <ul>
            <li>
              ...
              when it is best to call or text on the card, especially if you are
              working or have other commitments.
            </li>
            <li>
              <strong>Start small.</strong> Whether you’re working with a large
              group, or helping on your own, hand out a small amount of
          ...
          <p>
            ...
            >
              <strong>
                New research shows the virus can survive on cardboard for up to
                24 hours.
              </strong>
            </a>{' '}
            If you feel unwell, or have had contact with someone who has tested
            positive for COVID-19, please <strong>do not</strong> deliver
            postcards until you have cleared the 14 day self-isolation period.
          </p>

          <h2>Setting up a community care group: What you need to know!</h2>
          <p>
            Adding a community care group in your local area is easy! Here are a
            few tips, tricks and things to think about when starting your group:
          </p>
          ...
          <p>
            ...
            ‘About’ section of your page to help people decide if it's the group
            for them!
          </p>
          <p>
          ...
          <ol>
            ...
            <li>
              ...
              <p>
                ...
                degrading comments about things like appearance, race, religion,
                culture, sexual orientation, disability, gender or identity.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                Any personal info shared in the group should stay in the group.
              </p>
            </li>
            <li>
            ...
            <li>
              ...
              <p>
                ...
                sense of humor, this is not the platform for these types of
                jokes.
              </p>
            </li>
            <li>
